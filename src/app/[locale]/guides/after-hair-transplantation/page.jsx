...
import AfterHairTransplantationMain from '@/components/guides/afterHairTransplantation'
...
export default async function AfterHairTransplantationPage() {
    const videos = await getYoutubeVideos();
    return (
        <AfterHairTransplantationMain>
