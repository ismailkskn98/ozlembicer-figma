...
import BeforeHairTransplantationMain from '@/components/guides/beforeHairTransplantation';
...
export default async function BeforeHairTransplantationPage() {
    const videos = await getYoutubeVideos();
    return (
        <BeforeHairTransplantationMain>
