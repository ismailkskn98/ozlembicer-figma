                ...
                <article className='w-full flex flex-col items-start gap-9'>
                    ...
                    <div className='w-full flex flex-col items-start gap-4 text-coffee-dark'>
                        ...
                        <ul className='leading-relaxed list-disc list-outside pl-5'>
                            <li>Severely limited scalp donor area, such as advanced hair loss (Norwood Grade VI–VII)</li>
                            <li>Patients who have undergone previous hair transplant procedures and have depleted donor reserves</li>
                            <li>Cases where higher graft numbers are required but scalp donor capacity is insufficient</li>
                            <li>Scarring alopecia, burns, or trauma-related hair loss</li>
                            <li>To increase overall density, particularly in combination with scalp hair grafts</li>
                        </ul>
                ...
                <main className='grid grid-cols-2 w-full border-t border-coffee-dark/15 place-content-stretch place-items-stretch text-coffee-dark'>
                    ...
                    <article className='border-b border-coffee-dark/15 flex flex-col gap-9 py-5 pl-4'>
                        ...
                        <div className='w-full flex flex-col items-start gap-4 text-coffee-dark'>
                            ...
                            <ul className='leading-relaxed list-disc list-outside pl-5'>
                                <li>
                                    <strong>Conventional FUE:</strong>
