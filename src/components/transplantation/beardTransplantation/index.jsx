               ...
               <SectionWrapper>
                  <HowDoesItWork
                     ...
                     content={[
                        {
                           type: 'paragraph',
                           value: 'Nearly half of all men experience uneven or patchy beard growth, often due to genetic factors. Beard transplantation may be a suitable solution for men who:',
                        },
                        {
                           type: 'list',
                           value: [
                              'Cannot grow a full beard naturally',
                              'Have thin or patchy areas',
                              'Wish to define sharper beard contours',
                              'Have facial scars from injury, burns, surgery, or acne',
                           ],
                        },
                  ...
                  >
                     <main className="grid grid-cols-1 sm:grid-cols-2 w-full border-t border-ivory-soft/15 place-content-stretch place-items-stretch text-ivory-soft">
                        ...
                        <section className="col-span-1 sm:col-span-2 w-full flex flex-col items-start gap-4 mt-6 text-sm lg:text-base">
                           ...
                           <p>
                              Beard transplantation is a medical procedure, and results vary depending on individual healing capacity, hair characteristics, and surgical planning. A thorough
                              consultation is essential to set realistic expectations and achieve the best possible outcome.
                           </p>
                        </section>
                     </main>
                  </HowDoesItWork>
