...
export default function SpeaksLanguage() {
    return (
        <section className='fluid gridContainer w-full py-10'>
            <main className='w-full max-w-6xl mx-auto flex flex-col items-center justify-center gap-5 bg-radial from-coffee-dark to-wine-brown py-15 px-2.5 rounded-4xl'>
                <MotionScrollInViewVariant className='w-full max-w-213.75 mx-auto flex items-center justify-between gap-5' childClassname="object-contain object-center rounded-2xl w-30.25 h-20">
