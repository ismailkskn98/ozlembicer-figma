...
export default function SpeaksLanguage() {
   ...
   const handleConfirm = () => {
      ...
      startTransition(() => {
         router.replace({ pathname, query: currentSearchParams }, { scroll: false, locale: pendingLang.locale });
      });
   };
                  ...
                  {languages.map((lang, index) => {
                     ...
                     return (
                        ...
                        >
                           ...
                           <span className="text-ivory-soft text-sm sm:text-base font-medium">{lang.name}</span>
                        </div>
                     );
                  })}
               </MotionScrollInViewVariant>
