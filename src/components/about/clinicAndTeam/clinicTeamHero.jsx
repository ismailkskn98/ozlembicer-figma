               ...
               <article className="w-full flex flex-col lg:flex-row items-start lg:items-center gap-6 text-ivory-soft">
                  ...
                  <div className="flex-1 flex flex-col items-start gap-2">
                     ...
                     <p className="text-sm sm:text-base">
                        ...
                        medical team assists Dr. Biçer in every procedure, allowing for full focus, continuity, and
                        personalized attention. This approach enables us to maintain strict quality control, provide
                        attentive patient care, and strive for natural, reliable results in every case.
                     </p>
                  </div>
               </article>
            </MotionRightView>
