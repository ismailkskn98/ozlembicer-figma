   ...
   return (
      <section className="relative fluid gridContainer w-full bg-wine-brown pt-12 sm:pt-18.25 pb-20 sm:pb-25 lg:pb-36">
         ...
         <main className="w-full max-w-full xl:max-w-6xl mx-auto flex flex-col items-start gap-4">
            ...
            <div className="w-full grid lg:grid-cols-2 justify-items-stretch gap-12 lg:gap-32">
               <MotionLeftView className="order-2 lg:order-1 flex-1 w-full lg:max-w-120 flex">
                  <PhotoGallery />
               </MotionLeftView>
               <MotionRightView className="relative w-full order-1 lg:order-2 mx-auto h-full max-h-120 min-h-120 lg:min-h-157 lg:max-h-157.5 flex-1 rounded-2xl lg:rounded-4xl">
                  <Image
                     src="/images/about/clinic-gallery-right.png"
                     alt="Clinic Gallery"
                     fill
                     className="flex-1 object-cover object-center w-full h-full rounded-2xl lg:rounded-4xl"
                  />
               </MotionRightView>
            </div>
         </main>
