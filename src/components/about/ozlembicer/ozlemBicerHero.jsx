         ...
         <section className="w-full max-w-full xl:max-w-6xl mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-start lg:justify-between gap-10">
            ...
            <MotionRightView className="order-1 lg:order-2 w-full max-w-full lg:max-w-140.5">
               <Image
                  ...
                  width={1200}
                  height={800}
                  className="object-cover lg:object-contain object-[50%_15%] lg:object-center mx-auto w-full max-w-full lg:max-w-135 2xl:max-w-140.5 h-fit max-h-100 sm:max-h-130 md:max-h-150 lg:max-h-fit rounded-2xl lg:rounded-4xl"
               />
            </MotionRightView>
         </section>
      </main>
