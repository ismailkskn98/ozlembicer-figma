                  ...
                  <SwiperSlide key={index} className="w-full pr-1">
                     {({ isActive }) => (
                        <div className={`w-full flex flex-col lg:flex-row items-center lg:items-end justify-center lg:justify-between gap-10 xl:gap-15`}>
                           ...
                           <div
                              className={cn(
                                 'relative order-1 lg:order-2 flex-1 w-full max-h-150 aspect-678/510 min-[65rem]:aspect-678/495 rounded-lg transition-all duration-500',
                           ...
                           >
                              <Image src={item.imageSrc} alt={item.imageAlt} fill className={cn(' object-cover object-center lg:object-top rounded-lg')} unoptimized />
                           </div>
