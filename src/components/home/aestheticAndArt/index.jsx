      ...
      <main className="relative z-20 w-full max-w-full xl:max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
        <MotionLeftView className="flex order-2 lg:order-1">
          <article className="flex-1 flex flex-col item-start justify-between gap-5 sm:gap-7.5 text-ivory-soft">
            ...
            <div className="w-full flex flex-col items-start text-start max-w-134">
              <p className="">
                Since 1998, I have been dedicated to the field of hair
                restoration and hair transplantation. At my clinic, we provide a
                high standard of medical care and professional expertise, with a
                clear focus on achieving natural, healthy, and long-lasting
                results for our patients.
              </p>
              <br />
              <p className="">
                Over the years, we have built a strong reputation by combining
                surgical experience, advanced technology, and strict adherence
                to safe and ethical medical practices. Every treatment is
                carefully planned and tailored to the individual needs of each
                patient.
              </p>
              <br />
              <p className="">
                If you are seeking a world-class hair transplant clinic that
                prioritizes medical excellence, natural outcomes, and patient
                care, my experienced medical team and I are here to guide you
        ...
        <MotionRightView className="w-full lg:w-fit mx-auto max-w-full lg:max-w-141 h-full order-1 lg:order-2">
          <div className="relative w-full lg:w-fit h-160 lg:h-180 xl:h-199 rounded-4xl overflow-hidden">
            <Image
              src="/images/aestheticAndArt.png"
              alt="aesthetic and art"
              fill
              className="object-cover lg:object-contain object-center w-full h-full rounded-4xl"
            />
          </div>
        </MotionRightView>
      </main>
