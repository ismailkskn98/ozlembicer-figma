            ...
            <main className='relative z-20 w-full max-w-full xl:max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-6'>
                <MotionLeftView className="order-2 lg:order-1">
                    <article className='flex flex-col item-start gap-5 sm:gap-7.5 text-ivory-soft'>
                        ...
                        <p className=''>If you are seeking a world-class hair transplant clinic that prioritizes medical excellence, natural outcomes, and patient care, my experienced medical team and I are here to guide you through every step of your journey.<br />Özlem Biçer, M.D.</p>
                        <div className='flex flex-col sm:flex-row items-start sm:items-center justify-end gap-3 lg:gap-6'>
                            <Link href="/about-us/dr-ozlem-bicer" className='rounded-[10px] py-2 xl:py-2.5 px-3 xl:px-3.75 text-xs lg:text-sm border border-ivory-soft text-ivory-soft hover:bg-ivory-soft/70 hover:text-coffee-dark hover:border-transparent transition-colors duration-200'>
