...
export default function TitleImages() {
    return (
        <MotionScrollInViewVariant className='w-full max-w-282 mx-auto flex flex-col items-start gap-5 bg-linear-to-r from-wine-brown to-coffee-dark min-h-175 rounded-4xl p-10 my-10' childClassname="w-full flex items-center justify-between gap-2.5">
