            ...
            <main className='w-full flex flex-col items-start lg:items-center justify-start lg:justify-center gap-6'>
                    ...
                    {appointmentSteps.map((step) => (
                        <article key={step.id} className='group w-full max-w-sm lg:max-w-full flex flex-col items-center justify-center bg-coffee-dark rounded-4xl pt-6 lg:pt-8 px-2.5 pb-8 lg:pb-14.75 h-full max-h-95'>
                            <div className='w-xs lg:w-auto flex items-center gap-4 lg:gap-0 text-ivory-soft'>
                                ...
                                <span className='text-[80px] 2xl:text-[96px]'>{step.id}</span>
                                <div className='relative w-full'>
                                    <p className='text-[28px] 2xl:text-[32px] leading-8 2xl:leading-9 opacity-0 lg:opacity-100 lg:group-hover:opacity-0 transition-all duration-300'>{step.title}<br />{step.titleBr}</p>
                                    <p className='w-full absolute left-0 top-1/2 -translate-y-1/2 text-[28px] 2xl:text-[32px] leading-8 2xl:leading-9 text-nowrap opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-200'>{step.hoverTitle}<br />{step.hoverTitleBr}</p>
                                </div>
                            </div>
                            <div className='relative h-38.25 w-full lg:w-auto'>
                                ...
                                <p className='w-xs lg:w-full absolute left-1/2 top-1/2 -translate-1/2 text-[14px] text-ivory-soft opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-200'>{step.description}</p>
                            </div>
                        </article>
                    ))}
                ...
                <MotionScrollInView className='w-full max-w-full xl:max-w-6xl mx-auto flex flex-col lg:flex-row items-start lg:items-center gap-6'>
                    ...
                    <article className='group relative w-full lg:w-auto max-w-sm lg:max-w-full flex-1 min-h-60 lg:min-h-74.25 flex items-center justify-center bg-coffee-dark text-ivory-soft rounded-4xl py-25 px-12.5'>
                        <span className='opacity-0 lg:opacity-100 lg:group-hover:opacity-0 transition-opacity duration-300 uppercase text-[28px] md:text-[32px] text-nowrap'>Contact US</span>
                        <div className='w-fit flex flex-col items-center justify-center gap-2 absolute left-1/2 top-1/2 -translate-1/2 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300'>
                            <span className='inline-block lg:hidden uppercase text-[28px] md:text-[32px] text-nowrap'>Contact US</span>
                            <div className='flex flex-col items-center justify-center text-[25px] lg:text-[32px]'>
