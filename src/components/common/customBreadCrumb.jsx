...
export default function CustomBreadCrumb({ links, isButton = false }) {
    ...
    return (
        <Breadcrumb className="sticky top-26.5 sm:top-33 lg:top-30 z-20 breadcrumb-scroll fluid gridContainer bg-coffee-dark border-b border-coffee-dark overflow-x-auto lg:overflow-hidden">
