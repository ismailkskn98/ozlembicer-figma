      ...
      <div className="w-full xl:max-w-262 mx-auto flex flex-col items-center justify-center gap-5 sm:gap-7">
         <Swiper
            ...
            breakpoints={{
               ...
               820: { slidesPerView: 2.5, spaceBetween: 15 },
               570: { slidesPerView: 2, spaceBetween: 15 },
               500: { slidesPerView: 1.5, spaceBetween: 15 },
         ...
         >
            {selectedItem && (
               <>
                  ...
                  <DialogContent showCloseButton={false} className="max-w-[90vw] z-9999999 md:max-w-150 p-0 border-0 bg-transparent shadow-none animate-in zoom-in-95 fade-in duration-200">
