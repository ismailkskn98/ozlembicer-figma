...
export default function HeroCards() {
    return (
        <main className='fluid gridContainer w-full h-60 md:h-50 absolute left-1/2 bottom-full translate-y-1/2 -translate-x-1/2'>
            <section className='w-full max-w-full lg:max-w-6xl mx-auto rounded-[10px] bg-coffee-dark'>
