         ...
         <section className="w-full max-w-full lg:max-w-6xl mx-auto rounded-[10px] bg-coffee-dark overflow-hidden">
            <MotionScrollInViewVariant className="w-full grid grid-cols-2 md:grid-cols-4 place-content-stretch justify-items-stretch rounded-[10px]">
               <article className="relative flex flex-col items-center justify-center gap-2.5 xl:gap-3.75 py-5 sm:py-7 xl:py-8.5 px-5 sm:px-9 xl:px-11.25">
                  <Image src="/images/heroCard-1.webp" alt="hero card 1" width={50} height={50} className="object-contain object-center w-9 sm:w-10 h-9 sm:h-10" />
                  <Image src="/images/heroCard-line.webp" alt="hero card line" width={150} height={10} className="object-contain object-center w-30 h-2" />
               ...
               <article className="relative flex flex-col items-center justify-center gap-2.5 xl:gap-3.75 py-5 sm:py-7 xl:py-8.5 px-5 sm:px-9 xl:px-11.25">
                  <Image src="/images/heroCard-2.webp" alt="hero card 2" width={50} height={50} className="object-contain object-center w-9 sm:w-10 h-9 sm:h-10" />
                  <Image src="/images/heroCard-line.webp" alt="hero card line" width={150} height={10} className="object-contain object-center w-30 h-2" />
                  <div className="flex flex-col items-center justify-center text-center text-base xl:text-[20px] text-transparent bg-linear-to-t from-gold to-ivory-soft bg-clip-text">
                     <span>28 Years</span>
               ...
               <article className="relative flex flex-col items-center justify-center gap-2.5 xl:gap-3.75 py-5 sm:py-7 xl:py-8.5 px-5 sm:px-9 xl:px-11.25">
                  <Image src="/images/heroCard-3.webp" alt="hero card 3" width={50} height={50} className="object-contain object-center w-9 sm:w-10 h-9 sm:h-10" />
                  <Image src="/images/heroCard-line.webp" alt="hero card line" width={150} height={10} className="object-contain object-center w-30 h-2" />
                  <div className="flex flex-col items-center justify-center text-center text-base xl:text-[20px] text-transparent bg-linear-to-t from-gold to-ivory-soft bg-clip-text">
                     <span>Licenced</span>
                     <span>Clinic</span>
