         ...
         items: [
            {
               ...
               items: [
                  ...
                  'FUT',
                  'Reconstructive Hair Transplant',
               ],
            },
         ],
      },
                     ...
                     <AccordionItem value={item.value} className={cn('flex-1 border-none')}>
                        <div className="relative h-full flex-1 flex flex-col gap-0 w-full overflow-hidden">
                           ...
                           >
                              {!isOpen && (
                                 <div className="h-full w-full flex items-start md:items-end justify-center md:pb-10 cursor-pointer">
                                    <div
                                       className={cn(
                                          'absolute inset-0 flex flex-row md:flex-col items-center justify-between gap-4 md:gap-0 px-4 md:px-0 py-4 md:py-6',
                                          {
                                             'bg-coffee-dark/80 hover:bg-coffee-dark/50 transition-all duration-200':
                                                !isOpen,
                                          },
                                       )}
                                    >
                           ...
                           >
                              ...
                              <h3 className="relative z-20 text-base md:text-lg 3xl:text-xl text-ivory-soft mb-2.5 md:mb-4">
                                 {item.content.title}
                              </h3>
