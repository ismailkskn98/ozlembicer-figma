...
export default function HeaderLogo() {
   ...
   return (
      <Link href={'/'} onClick={handleClick} className="relative h-[99%] w-fit flex items-center justify-center">
         ...
         <Image src="/images/logo.webp" alt="ozlembicer logo" width={150} height={100} className="relative z-20 object-contain object-center w-fit sm:min-w-31.25 h-9 sm:h-10 lg:h-11 xl:h-15" />
      </Link>
   );
}
