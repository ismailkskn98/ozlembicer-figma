                ...
                <MotionScrollInViewOpacity className="w-full flex items-center">
                    <section className='w-full h-full max-w-full lg:max-w-6xl mx-auto flex items-center justify-between'>
                        ...
                        <main className='hidden md:flex items-center'>
                            ...
                            <Link href="/contact-us" className='group hidden lg:flex flex-col items-center justify-center px-3.75 py-2.5 rounded-[10px] text-ivory-soft text-sm bg-wine-brown border border-wine-brown transition-all duration-300'>
