            ...
            links: [
                {
                    ...
                    submenu: [
                        { href: '/fue-micro-motor', label: 'FUE (Micro Motor)' },
                        { href: '/fue-manuel', label: 'FUE (Manuel)' },
                        { href: '/body-hair-transplant', label: 'BHT (Body Hair Transplant)' },
                        { href: '/reconstructive-hair-transplant', label: 'Reconstructive Hair Transplant' },
                        { href: '/long-hair', label: 'Long Hair (Unshaven)' },
                        { href: '/fut', label: 'FUT' },
                    ],
                },
