...
export default function BeforeHairTransplantationHero() {
   const t = useTranslations('Content.guides.beforeHairTransplantation.beforeHairTransplantationHero');
    return (
            ...
            <section className='w-full max-w-full xl:max-w-6xl mx-auto flex flex-col items-center justify-start gap-6'>
                <MotionLeftView className="w-full max-w-10/12 lg:max-w-full">
                    <article className='w-full flex flex-col items-start gap-6 lg:gap-7.5 text-ivory-soft'>
                        <h1 className='text-[40px] sm:text-[45px] lg:text-[50px] xl:text-[56px] 2xl:text-[64px] leading-10 sm:leading-12 lg:leading-14 xl:leading-16 flex flex-col items-start'>{t('heading1')} <span className='font-bold'>{t('span1')}</span></h1>
