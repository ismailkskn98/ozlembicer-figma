...
export default function AfterHairTransplantationDoesItWork() {
   return (
      <main className="grid grid-cols-1 sm:grid-cols-2 w-full border-t border-coffee-dark/15 place-content-stretch place-items-stretch text-coffee-dark">
         <h4 className="col-span-1 sm:col-span-2 font-bold text-base lg:text-[20px] flex flex-col items-start pb-4 sm:pb-12 pt-8 sm:pt-12">Main Medical Causes of Hair Loss in Men</h4>
         <article className="sm:border-r border-b border-coffee-dark/15 border-dashed flex flex-col gap-4 lg:gap-9 py-5 sm:pr-4">
            ...
            <div className="w-full flex flex-col items-start gap-4 text-coffee-dark text-sm lg:text-base">
               <p>
                  Androgenetic alopecia is a genetically inherited form of hair loss caused by the activity of 5-alpha reductase type I and type II enzymes, which convert testosterone into
                  dihydrotestosterone (DHT). In genetically predisposed individuals, DHT binds to sensitive hair follicles, leading to progressive follicular miniaturization and hair loss over time.
               </p>
         ...
         <article className="sm:border-r border-b border-coffee-dark/15 border-dashed flex flex-col gap-4 lg:gap-9 py-5 sm:pr-4">
            ...
            <div className="w-full flex flex-col items-start gap-4 text-coffee-dark text-sm lg:text-base">
               ...
               <p>
                  Hair transplantation into scar tissue may be possible, but graft survival can be lower because scar tissue has reduced blood circulation. We have no chance to perform hair
                  transplantation to the patient who have active cicatricial alopecia.
               </p>
            </div>
         </article>
         <article className="border-b border-coffee-dark/15 border-dashed flex flex-col gap-4 lg:gap-9 py-5 sm:pl-4">
         ...
         <article className="sm:border-r border-coffee-dark/15 border-dashed flex flex-col gap-4 lg:gap-9 py-5 sm:pr-4">
            ...
            <div className="w-full flex flex-col items-start gap-4 text-coffee-dark text-sm lg:text-base">
               <p>
                  If you experience sudden or rapid hair loss, or notice bald patches forming, you should seek medical advice. Hair loss can sometimes be associated with underlying medical or
                  autoimmune conditions that require proper diagnosis and treatment.
               </p>
            </div>
         </article>
         <article className="flex flex-col gap-4 lg:gap-9 py-5 sm:pl-4">
            ...
            <div className="w-full flex flex-col items-start gap-4 text-coffee-dark text-sm lg:text-base">
               <p>
                  To receive a precise evaluation of your hair loss stage and treatment options, you can consult Dr. Özlem Biçer and her experienced medical team. A professional diagnosis ensures that
                  the most suitable therapy or reconstructive approach is selected for your individual case.
               </p>
            </div>
         </article>
      </main>
