        ...
        <section className='w-full fluid gridContainer py-15'>
            <main className='w-full flex flex-col items-center justify-center gap-6'>
                <MotionScrollInView className="w-full">
                    <h2 className='w-full max-w-308 mx-auto text-[30px] text-center text-coffee-dark border-b-4 border-coffee-dark'>How To Make An Appointment</h2>
                </MotionScrollInView>
                <MotionScrollInViewVariant className='w-full max-w-308 mx-auto grid grid-cols-3 gap-6'>
