                ...
                <MotionRightView className="w-full max-w-286.5 mx-auto">
                    <article className='w-full flex items-start gap-6 text-ivory-soft'>
                        <div className='flex-1 flex flex-col items-start gap-6'>
                            ...
                            <p className='text-sm sm:text-base'>Eyebrow transplantation is a delicate hair restoration procedure designed to improve eyebrow density, shape, and symmetry. Performed by Dr. Özlem Biçer and her experienced medical team, this procedure allows patients to achieve natural-looking, permanent eyebrows with minimal downtime.</p>
                            <p className='text-sm sm:text-base'>Eyebrows play a crucial role in facial balance and expression. They frame the eyes and contribute significantly to emotional expression and overall facial harmony. While over-plucking or shaping can easily thin thick eyebrows, restoring sparse, irregular, or missing eyebrows is far more complex—making eyebrow transplantation an effective long-term solution.</p>
                        </div>
                    </article>
                </MotionRightView>
            </section>
