         ...
         <section className="flex-1 flex flex-col items-start">
            <article className="w-full col-span-1 sm:col-span-2 flex flex-col items-start gap-2.5 sm:gap-3.5 mt-5">
               ...
               <p className="w-full max-w-190 text-sm xl:text-base">
                  The Norwood Scale is the most widely used tool to evaluate and classify male pattern baldness, also known as androgenetic alopecia. It helps both doctors and patients understand the
                  severity and progression of hair loss in men.
               </p>
            ...
            <article className="w-full col-span-1 sm:col-span-2 flex flex-col items-start gap-2.5 sm:gap-3.5 mt-5">
               ...
               <p className="w-full max-w-190 text-sm xl:text-base">
                  The classification system was originally introduced by Dr. James Hamilton in the 1950s. It was later refined and expanded by Dr. O’Tar Norwood in the 1970s, who adapted the scale
                  specifically for the assessment of male pattern hair loss.
               </p>
            ...
            <article className="w-full col-span-1 sm:col-span-2 flex flex-col items-start gap-2.5 sm:gap-3.5 mt-5">
               ...
               <p className="w-full max-w-190 text-sm xl:text-base">
                  The Norwood Scale is used to determine how advanced a patient’s hair loss is. It provides a visual and clinical reference, allowing both the physician and the patient to compare the
                  hairline and crown with standardized stages.
               </p>
