      ...
      <main className="relative fluid gridContainer w-full bg-radial from-coffee-dark to-wine-brown pt-12 lg:pt-25 pb-50 overflow-hidden">
         ...
         <section className="w-full max-w-full xl:max-w-6xl mx-auto flex flex-col items-center justify-start gap-6">
            <MotionRightView className="w-full max-w-full">
               <Image
                  src="/images/hair-loss/hair-tricopat.png"
                  alt="Dr. Özlem Bicer"
                  width={1200}
                  height={600}
                  unoptimized
            ...
            <MotionLeftView className="w-full max-w-full lg:max-w-full">
               <article className="w-full flex flex-col items-start gap-6 lg:gap-7.5 text-ivory-soft">
                  <h1 className="text-[40px] sm:text-[45px] lg:text-[50px] xl:text-[56px] 2xl:text-[64px] leading-10 sm:leading-12 lg:leading-14 xl:leading-16 flex flex-col items-start">
                     What Is <span className="font-bold">Tricopat?</span>
                  </h1>
                  <div className="w-full flex flex-col items-start gap-4">
                     <p className="text-sm sm:text-base">
                        TRICOPAT® is a patented, non-invasive medical device developed in Italy for the treatment of hair loss and scalp disorders. It is scientifically
